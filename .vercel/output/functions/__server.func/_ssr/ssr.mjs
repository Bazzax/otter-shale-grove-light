...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Divkr5RR.mjs");
...
var manifest = { "38c87ac6dc05c338c9728fe5e79a8b13fe192b26d07d97b19a7181d26ae3f748": {
	functionName: "askAl_createServerFn_handler",
	importer: () => import("./ask-al-RY2x3M2j.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BWN1sZKx.mjs").then((n) => n.t),
